      ...
      <div className="flex-1 p-6 ml-48 pl-4">
        ...
        <div className="relative overflow-x-auto shadow-md">
          <table className="w-full text-sm text-left text-gray-700">
            ...
            <tbody className="divide-y divide-gray-400 bg-gray-100">
              {filteredBerita.map((berita, index) => {
                const formattedDate = berita.tanggalTerbit ? berita.tanggalTerbit.split("T")[0] : "";

                return (
                  <tr key={berita.id} className="hover:bg-gray-100">
                    <td className="px-6 py-4 text-center">{index + 1}</td>
                    <td className="px-6 py-4 text-center">{berita.nama}</td>
                    <td className="px-6 py-4 text-center">{berita.penulis}</td>
                    <td className="px-6 py-4 text-center">{berita.deskripsi}</td>
