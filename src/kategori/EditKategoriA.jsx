...
const EditKategoriA = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!namaKategori.trim()) return Swal.fire("Error", "Nama kategori tidak boleh kosong!", "error");
    ...
    fetch(`http://localhost:4321/api/kategori/edit/${id}`, {
      ...
      .then(() => Swal.fire("Sukses", "Kategori berhasil diperbarui", "success").then(() => navigate("/page-kategori")))
      .catch(() => Swal.fire("Error", "Terjadi kesalahan saat memperbarui kategori", "error"));
  };
      ...
      <div className="bg-white p-6 shadow-md rounded-lg w-1/2 border-2 border-gray-700">
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between">
            <button type="button" className="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 flex items-center gap-2" onClick={() => navigate("/page-kategori")}>
