            ...
            <table className="w-full text-sm text-left text-gray-700 border border-gray-400">
              <thead className="text-xs font-bold uppercase bg-gray-200 border-b border-gray-500">
                <tr>
                  ...
                  <th className="px-6 py-3 border-r text-center">Nama Donasi</th>
                  <th className="px-6 py-3 border-r text-center">Nama Donatur</th>
                  <th className="px-6 py-3 border-r text-center">Jumlah Donasi</th>
                  <th className="px-6 py-3 border-r text-center">Deskripsi</th>
