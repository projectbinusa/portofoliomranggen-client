...
export const API_URL = url; // Add this line if API_URL is needed

export const API_STAFF = `${url}/staff`;
...
export const API_BUKU = `${url}/admin/buku`;
export const API_PRODUK = `${url}/produk`;
