...
const produkList = [
  ...
  { id: 3, name: "Luxury Watch", brand: "Centrix", category: "Fashion", price: 29.99, oldPrice: 36.0, rating: 4.5, discount: 20, image: image3 },
  ...
  { id: 6, name: "Cover All Perfect Cushion", brand: "Skintific", category: "Beauty", price: 5.99, oldPrice: 10.55, rating: 5.0, discount: 50, image: image6 },
  { id: 7, name: "5X Ceramide Serum Sunscreen", brand: "Skintific", category: "Beauty", price: 50.99, oldPrice: 70.55, rating: 5.0, discount: 40, image: image7 },
  { id: 8, name: "Dior Addict Lip Glow001", brand: "Dior", category: "Beauty", price: 35.89, oldPrice: 45.5, rating: 5.0, discount: 10, image: image8 },
  { id: 9, name: "Dior Forever Perfect Cushion", brand: "Dior", category: "Beauty", price: 20.99, oldPrice: 74.45, rating: 5.0, discount: 20, image: image9 },
];
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-6">
          <Grid container spacing={2}>
            ...
            {/* Produk Info */}
            <Grid item xs={12} md={6} lg={6} sx={{ display: "flex", flexDirection: "column", justifyContent: "center", minHeight: 500 }}>
            ...
            {/* Produk Related (Dapat di-scroll) */}
            <Grid item xs={12} md={5} xl={4}>
              <MainCard title="Produk Related">
