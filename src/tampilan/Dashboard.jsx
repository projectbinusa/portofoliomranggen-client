...
import Sidebar from "../components/Sidebar"; // Pastikan path ini sesuai dengan lokasi file Sidebar.js

export default function Dashboard() {
  return (
    <div className="flex min-h-screen bg-gray-800">
      <Sidebar />
      <div className="p-6 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 flex-1">
