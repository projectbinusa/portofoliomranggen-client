    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-col flex-1">
        ...
        >
          ...
          <DashboardCard icon={<FaCalendarAlt />} label="Kegiatan Sekolah" count={dataCounts.kegiatan} description="Total kegiatan sekolah yang terdaftar." color="bg-[#3674B5]" textColor="text-white" onClick={() => navigate("/kegiatan")} />
